<div class="header align-items-stretch" id="kt_header" style="height: 100px;">
    <!--begin::Container-->
    <div class="container-fluid justify-content-between" id="ctn_header" >
        <!--begin::Aside mobile toggle-->
        
        <div class="d-flex align-items-center d-lg-none ms-n2 me-2" title="Show aside menu">
            <div class="btn btn-icon btn-active-light-primary w-10px h-30px w-md-40px h-md-40px" id="kt_aside_mobile_toggle">
        ...
        <!--end::Mobile logo-->
        <!--begin::Wrapper-->
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-3">
            <!--begin::Navbar-->
