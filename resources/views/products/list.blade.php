                                ...
                                <table class="table table-striped fs-6 g-5" id="dt_datatable">
                                    <thead class="text-gray-400">
                                        ...
                                        <tr class="text-start text-gray-400 fw-bolder fs-7">
                                            ...
                                            <th class="min-w-100px text-black">Product Name</th>
                                            <th class="min-w-100px text-black">Code</th>
                                            <th class="min-w-100px text-black">Price</th>
        ...
        $(document).ready(function(){
            ...
            $(selector_id).on('click', '.btn_show', function () {
                ...
                success: function (res) {
                    ...
                    $('#show_code').val(res.data.code)
                    $('#show_price').val(res.data.price)
                },
                complete: function () {
